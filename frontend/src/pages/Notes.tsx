          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1 font-medium">
                Transform lecture video transcripts into structured, revision-ready study notes with definitions, key formulas, and examples.
              </p>
            </div>
          </div>
          ...
          {!selectedCourse ? (
            <div className="bg-[#25272F] rounded-2xl p-5 sm:p-7 border border-[#333642] shadow-xs">
              <CourseSelectionScreen
                studioTitle="Choose a Course for AI Study Notes"
                studioSubtitle="Select an enrolled course below to generate comprehensive study guides. Only videos from your chosen course will be synthesized."
                studioIcon={<BookOpen className="w-8 h-8 text-[#E5F842]" />}
                actionText="Generate Study Notes"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#25272F] rounded-3xl p-6 sm:p-8 border border-[#333642] shadow-xs">
                <NotesComponent course={selectedCourse} />
              </div>
            </div>
          )}
        </div>
